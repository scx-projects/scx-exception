...
public class ScxWrappedExceptionTest {
    ...
    public static void read(Func<byte[], ?> bytesConsumer, int length) throws ScxWrappedException, IOException {
        if (length > 2048) {
    ...
    public static void test2() {
        ...
        try {
            ...
            Assert.assertEquals(e.getUnwrappedCause().getMessage(), "lambda error");
        }
    }
